...
#define PACKAGE_STRING "slurm 24.11"
...
#define SLURM_VERSION_NUMBER 0x180b05

/* Define the project's version string. */
#define SLURM_VERSION_STRING "24.11.5"
